...
STRING y mas!!!!
"""
esto_es_una_string = "Hola Ninoska como estas"
...
# rebanar!!!!!  o slice
print(esto_es_una_string[0:2])  #tu le dices que inicie en cero
print(esto_es_una_string[:2])  #el asume que inicie en cero
